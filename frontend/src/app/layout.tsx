...
export const metadata: Metadata = {
  ...
  authors: [
    ...
    { name: "Community Scripts", url: "https://github.com/matthewbartos" },
  ],
  creator: "Bram Suurd",
  publisher: "Community Scripts",
  metadataBase: new URL(`https://matthewbartos.github.io/${basePath}/`),
  alternates: {
    canonical: `https://matthewbartos.github.io/${basePath}/`,
  },
  viewport: {
    width: "device-width",
    initialScale: 1,
  ...
  openGraph: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) Repository. Featuring over 300+ scripts to help you manage your Proxmox VE environment.",
    url: `https://matthewbartos.github.io/${basePath}/`,
    siteName: "Proxmox VE Helper-Scripts",
    images: [
      {
        url: `https://matthewbartos.github.io/${basePath}/defaultimg.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) Repository. Featuring over 300+ scripts to help you manage your Proxmox VE environment.",
    images: [`https://matthewbartos.github.io/${basePath}/defaultimg.png`],
  },
